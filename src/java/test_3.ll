...
@.str.0 = private unnamed_addr constant [43 x i8] c"Finding the smaller among 2 input numbers
\00", align 1
...
@.str.1 = private unnamed_addr constant [13 x i8] c"The  are : 
\00", align 1
...
@.str.3 = private unnamed_addr constant [32 x i8] c"
The smallest number them is : \00", align 1
...
%class.Test = type { %class.IO, i32 }
%class.Main = type { %class.Object, %class.Test* }
...
; class : 'Test function : constructor
define void @_CTest4_FTest4_(%class.Test* %this) {

entry:
  %0 = bitcast %class.Test* %this to %class.IO*
  call void @_CIO2_FIO2_(%class.IO* %0)
  %1 = getelementptr inbounds %class.Test, %class.Test* %this,  i32 0, i32 1
...
entry:
  ...
  call void @_CTest4_FTest4_(%class.Test* %3)
  store %class.Test* %3, %class.Test** %1, align 4
  ret void
}
...
; Class: 'Test' Function : 'condition'
define i32 @_CTest4_Fcondition9_(%class.Test* %this, i32 %x, i32 %y
) {
entry:
...
branch.normal.5:
  ...
  %29 = getelementptr inbounds %class.Test, %class.Test* %this,  i32 0, i32 1
  store i32 %28, i32* %29, align 4
  %30 = icmp eq %class.Test* %this, null
  br i1 %30, label %static.void, label %branch.normal.6

branch.normal.6:
  %31 = bitcast %class.Test* %this to %class.IO*
  %32 = getelementptr inbounds [32 x i8], [32 x i8]* @.str.3, i32 0, i32 0
  %33 = call %class.IO* @_CIO2_Fout_string10_(%class.IO* %31, i8* %32)
  %34 = icmp eq %class.Test* %this, null
  br i1 %34, label %static.void, label %branch.normal.7

branch.normal.7:
  %35 = bitcast %class.Test* %this to %class.IO*
  %36 = getelementptr inbounds %class.Test, %class.Test* %this,  i32 0, i32 1
  %37 = load i32, i32* %36, align 4
  %38 = call %class.IO* @_CIO2_Fout_int7_(%class.IO* %35, i32 %37)
  ret i32 0
}
...
method.body:
  ...
  %1 = load %class.Test*, %class.Test** %0, align 8
  %2 = icmp eq %class.Test* %1, null
  br i1 %2, label %static.void, label %branch.normal.8

branch.normal.8:
  %3 = call i32 @_CTest4_Fcondition9_(%class.Test* %1, i32 10, i32 20)
  ret i32 0
}
