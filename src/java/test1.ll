...
\00", align 1
@.str.36 = private unnamed_addr constant [4 x i8] c"%d
\00", align 1
...
\00", align 1
@.str.40 = private unnamed_addr constant [32 x i8] c"VOID Dispatach Found at line - \00", align 1
...
\00", align 1
@.str.41 = private unnamed_addr constant [33 x i8] c"ABORT Message called from class \00", align 1
...
@.str.38 = private unnamed_addr constant [10 x i8] c"%1024[^
]\00", align 1
@.str.39 = private unnamed_addr constant [42 x i8] c"Exception Divide By Zero Found at line - \00", align 1
...
entry:
  %0 = getelementptr inbounds %class.Object, %class.Object* %this, i32 0, i32 0
  %1 = load i8*, i8** %0, align 8
  %2 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.37, i32 0, i32 0
  %3 = getelementptr inbounds [33 x i8], [33 x i8]* @.str.41, i32 0, i32 0
...
entry:
  ...
  %1 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.35, i32 0, i32 0
...
entry:
  %0 = alloca i8*, align 8
  %1 = load i8*, i8** %0, align 8
  %2 = getelementptr inbounds [10 x i8], [10 x i8]* @.str.38, i32 0, i32 0
...
entry:
  %0 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.37, i32 0, i32 0
  %1 = getelementptr inbounds [32 x i8], [32 x i8]* @.str.40, i32 0, i32 0
 %2 = call i32 (i8*, ...) @printf(i8* %0, i8* %1)
  %3 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.35, i32 0, i32 0
...
entry:
  %0 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.37, i32 0, i32 0
  %1 = getelementptr inbounds [42 x i8], [42 x i8]* @.str.39, i32 0, i32 0
 %2 = call i32 (i8*, ...) @printf(i8* %0, i8* %1)
  %3 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.35, i32 0, i32 0
 %4 = call i32 (i8*, ...) @printf(i8* %3, i32 %lineNo)
  %5 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.26, i32 0, i32 0
