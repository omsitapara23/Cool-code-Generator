...
@.str.7 = private unnamed_addr constant [32 x i8] c"VOID Dispatach Found at line - \00", align 1
...
@.str.6 = private unnamed_addr constant [42 x i8] c"Exception Divide By Zero Found at line - \00", align 1
...
; Class: A, Method: getA
define i32 @_CA1_FgetA4_(%class.A* %this) {
...
; Class: A, Method: setA
define i32 @_CA1_FsetA4_(%class.A* %this, i32 %x) {
...
; Class: B, Method: getA
define %class.A* @_CB1_FgetA4_(%class.B* %this) {
...
define i32 @_CB1_FsetAVal7_(%class.B* %this) {
...
entry:
  ...
  %4 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.1, i32 0, i32 0
  store i8* %4, i8** %3, align 8
  %5 = getelementptr inbounds %class.Main, %class.Main* %this,  i32 0, i32 4
  %6 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.1, i32 0, i32 0
  ...
  call void @_CA1_FA1_(%class.A* %10)
  %11 = bitcast %class.A* %10 to %class.Object*
  store %class.A* %10, %class.A** %8, align 4
  %12 = getelementptr inbounds %class.Main, %class.Main* %this,  i32 0, i32 7
  %13 = call noalias i8* @malloc(i64 16)
  %14 = bitcast i8* %13 to %class.B*
  call void @_CB1_FB1_(%class.B* %14)
  %15 = bitcast %class.B* %14 to %class.Object*
  store %class.B* %14, %class.B** %12, align 4
  %16 = getelementptr inbounds %class.Main, %class.Main* %this,  i32 0, i32 8
  store %class.A* null, %class.A** %16, align 4
  ret void
}
...
entry:
  %0 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.4, i32 0, i32 0
  %1 = getelementptr inbounds [42 x i8], [42 x i8]* @.str.6, i32 0, i32 0
 %2 = call i32 (i8*, ...) @printf(i8* %0, i8* %1)
  %3 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.0, i32 0, i32 0
 %4 = call i32 (i8*, ...) @printf(i8* %0, i8* %3)
  call void @exit(i32 1)
