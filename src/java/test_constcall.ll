...
method.body:
  ...
  %2 = getelementptr inbounds [33 x i8], [33 x i8]* @.str.9, i32 0, i32 0
  %3 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.1, i32 0, i32 0
  %4 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.13, i32 0, i32 0
  %5 = call i32 (i8*, ...) @printf(i8* %1, i8* %2)
  %6 = call i32 (i8*, ...) @printf(i8* %1, i8* %4)
  %7 = call i32 (i8*, ...) @printf(i8* %1, i8* %3)
  call void @exit(i32 0)
  %8 = call noalias i8* @malloc(i64 0)
  %9 = bitcast i8* %8 to %class.Object*
  call void @_CObject6_FObject6_(%class.Object* %9)
  ret i32 0
}
